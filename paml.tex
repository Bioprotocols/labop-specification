...
\newcommand{\paml}[1]{\texttt{\hyperref[sec:#1]{#1}}}
...
% section.
\newcommand{\pamlmult}[2]{\texttt{\hyperref[sec:#1]{#2}}}
...
\title{Protocol Activity Markup Language \texorpdfstring{\\[3pt]}{}\mbox{(PAML) Version~1.0.0}}
